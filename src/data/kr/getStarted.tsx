    ...
    description: (
      <>
        ...
        <p>
          ...
          또는 <Link href="/api#Controller">Controller</Link>을 사용하여 구성
          요소를 래핑합니다.
          <Link href="/api/#ReactNative">React Native</Link> 섹션에서 더 많은
          내용을 읽을 수도 있습니다.
        </p>
      </>
    ),
    ...
    description: (currentLanguage) => (
      <>
        ...
        <p>
          ...
          <Link href="/api#register">register 섹션</Link>을 살펴보세요.
        </p>
      </>
    ),
  },
  ...
  controlledInput: {
    ...
    description: (
      <p>
        ...
        <Link href="/api#Controller">Controller</Link> 은 여전히 필요에 따라
        인풋 필드를 커스텀 등록하는 방법을 제공하여 위의 외부 컴포넌트들과 쉽게
        통합할 수 있습니다.
      </p>
    ),
  },
  workWithUI: {
    ...
    description: (currentLanguage) => (
      <>
        ...
        <p>
          그 다음으로 쉬운 방법은 <Link href="/api#Controller">Controller</Link>{" "}
